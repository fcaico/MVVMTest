...
namespace MVVMTest.Views
{
	public class BaseUIViewController: UIViewController
	{
		...
		public BaseUIViewController (ViewModelBase viewModel) : base()
		{
			_viewModel = viewModel;
		}
		
		public BaseUIViewController (ViewModelBase viewModel, NSCoder coder) : base(coder)
		{
			_viewModel = viewModel;
		}
		
		public BaseUIViewController (ViewModelBase viewModel, NSObjectFlag t) : base(t)
		{
			_viewModel = viewModel;
		}
		
		public BaseUIViewController (ViewModelBase viewModel, IntPtr handle) : base(handle)
		{
			_viewModel = viewModel;
		}
		
		public BaseUIViewController (ViewModelBase viewModel, string nibName, NSBundle bundle) : base (nibName, bundle)
		{
			_viewModel = viewModel;
		}
	}
